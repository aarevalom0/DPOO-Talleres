...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el País de un atleta (MODIFICACION)");
	...
	private void ejecutarConsultarPaisAtleta(){
		...
		String nameAtleta = input("Por favor ingrese el nombre del atleta para consultar el pais");
		String paisfind =  String.valueOf(calculadora.PaisAtletaEspecifico(nameAtleta));
		if (paisfind == null)
		{
			System.out.println("No se encontró un atleta llamado " + nameAtleta);
		}
		else
		{
			System.out.println("El País del atleta llamado " + nameAtleta +" es:" + paisfind);
		}
